      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Link
              to="/login"
              className="px-4 py-2 rounded-lg text-sm font-bold border border-emerald-500 text-emerald-600 hover:bg-emerald-50 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-emerald-400"
            >
              {lang === "ar" ? "دخول" : "Login"}
            </Link>
            ...
            >
              <div className="flex flex-col gap-5">
                ...
                <Link
                  ...
                  className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-bold text-emerald-600 bg-emerald-50 focus:outline-none focus:ring-2 focus:ring-emerald-400"
                >
                  {lang === "ar" ? "تسجيل الدخول" : "Dashboard Login"}
                </Link>
