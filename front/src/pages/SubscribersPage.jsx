...
import { faFilter, faListUl, faThLarge, faEnvelope, faCheck, faTimes, faQuestion, faEye, faCalendarDay, faCheckCircle, faTimesCircle, faRotateRight, faSquareCaretDown } from '@fortawesome/free-solid-svg-icons';
    ...
    <div className="space-y-6 pb-10" dir={titleDirection}>
      ...
      <div className="bg-white border border-slate-200 rounded-3xl shadow-sm p-5">
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-4">
          ...
          <Select
            label="Round"
            options={[{ value: '', label: 'All Rounds' }, ...subscriberRounds.filter((item) => item.value)]}
            value={filters.round}
