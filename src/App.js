  ...
  const content = {
    ar: {
      ...
      hero: {
        ...
        subtitle: 'موثق ليس مجرد دورة تدريبية، إنه محاكاة حقيقية لبيئة العمل. اكتسب الخبرة العملية التي تحتاجها للنجاح في سوق العمل.',
      ...
      success: {
        ...
        stories: [
          {
            quote: 'موثق ساعدني على كسر حاجز الخوف من الإنتاج. الآن أعمل بثقة في شركة كبرى.',
            name: 'أحمد محمد',
            position: 'Full Stack Developer',
            company: 'شركة تقنية كبرى'
          },
          {
            quote: 'البيئة المحاكاة أعطتني الخبرة التي كنت أحتاجها. بنيت معرض أعمال احترافي.',
            name: 'فاطمة علي',
            position: 'Frontend Developer',
            company: 'شركة ناشئة'
          },
          {
            quote: 'تعلمت كيفية العمل ضمن فريق Agile. هذا كان المفتاح للحصول على وظيفتي.',
            name: 'محمد خالد',
    ...
    en: {
      ...
      hero: {
        ...
        subtitle: 'Mawthiq is not just a training course, it\'s a real work environment simulation. Gain the practical experience you need to succeed in the job market.',
      ...
      success: {
        ...
        stories: [
          {
            quote: 'Mawthiq helped me break the fear of production. Now I work confidently at a major company.',
            name: 'Ahmed Mohammed',
            position: 'Full Stack Developer',
            company: 'Major Tech Company'
          },
          {
            quote: 'The simulation environment gave me the experience I needed. I built a professional portfolio.',
            name: 'Fatima Ali',
            position: 'Frontend Developer',
            company: 'Startup Company'
          },
          {
            quote: 'I learned how to work in Agile teams. This was the key to getting my job.',
  ...
  return (
    <div className={`min-h-screen bg-soft-gray ${t.font}`} dir={t.dir}>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                ...
                <div className="flex items-center gap-4 px-4">
                  <div className="flex -space-x-3">
                    {[1, 2, 3, 4].map(i => (
                      <div key={i} className="w-10 h-10 bg-gradient-to-br from-deep-blue to-emerald rounded-full border-2 border-white flex items-center justify-center text-white text-xs font-bold">
                        {i}
                      </div>
                    ))}
                  </div>
                  <span className="text-sm text-gray-600 font-semibold">{t.hero.stats}</span>
                </div>
              </div>
            </div>
            ...
            <div data-aos="fade-left" className="relative">
              <div className="relative z-10">
                <div className="bg-white rounded-2xl shadow-2xl p-6 border border-gray-100">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="text-xs text-gray-500 font-mono">Mawthiq IDE</div>
                  </div>
                  
                  <div className="bg-gray-900 rounded-lg p-4 font-mono text-sm">
                    <div className="text-green-400 mb-2">// Welcome to Mawthiq</div>
                    <div className="text-blue-400 mb-2">class CareerBridge {'{'}</div>
                    <div className="text-gray-400 ml-4 mb-2">constructor() {'{'}</div>
                    <div className="text-emerald-400 ml-8 mb-2">this.status = 'Expert';</div>
                    <div className="text-emerald-400 ml-8 mb-2">this.confidence = 100;</div>
                    <div className="text-gray-400 ml-4 mb-2">{'}'}</div>
                    <div className="text-blue-400">{'}'}</div>
                    
                    <div className="mt-4 flex gap-2">
                      <span className="px-2 py-1 bg-emerald/20 text-emerald text-xs rounded">✓ Sprint Active</span>
                      <span className="px-2 py-1 bg-blue-500/20 text-blue-400 text-xs rounded">PR Approved</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute bottom-10 -left-10 w-16 h-16 bg-deep-blue/20 rounded-full animate-float" style={{ animationDelay: '1s' }}></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12" data-aos="fade-up">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 gradient-text">{t.problem.title}</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <p className="text-gray-600 leading-relaxed">{t.problem[item.key + 'Desc']}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12" data-aos="fade-up">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 gradient-text">{t.techStack.title}</h2>
          ...
          <div className="mb-12">
            <div className="flex flex-wrap justify-center gap-8" data-aos="fade-up">
              {t.techStack.techs.map((tech, index) => (
                <div key={index} className="tech-logo bg-gray-50 p-6 rounded-xl border border-gray-200 text-center">
          ...
          <div className="text-center">
            <div className="inline-flex flex-wrap gap-3" data-aos="fade-up">
              {t.techStack.methodologies.map((method, index) => (
                <span key={index} className="px-4 py-2 bg-deep-blue/10 text-deep-blue rounded-full font-semibold">
                  {method}
                </span>
              ))}
            </div>
      ...
      <section id="requirements" className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12" data-aos="fade-up">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 gradient-text">{t.requirements.title}</h2>
      ...
      <section id="journey" className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12" data-aos="fade-up">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 gradient-text">{t.journey.title}</h2>
      ...
      <section id="success" className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-deep-blue to-emerald text-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12" data-aos="fade-up">
      ...
      <section id="partners" className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12" data-aos="fade-up">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 gradient-text">{t.partners.title}</h2>
            <p className="text-lg text-gray-600">{t.partners.subtitle}</p>
          </div>
          
          <div className="flex flex-wrap justify-center items-center gap-8 opacity-60">
            {['Google', 'Microsoft', 'Amazon', 'IBM', 'Oracle', 'SAP'].map((partner, index) => (
              <div
                key={index}
      ...
      {/* CTA Section */}
      <section id="cta" className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-deep-blue to-emerald text-white">
            ...
            {!isFormSubmitted ? (
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-semibold mb-2">{t.cta.form.name}</label>
                    <input
                      type="text"
                      required
                  ...
                  <div>
                    <label className="block text-sm font-semibold mb-2">{t.cta.form.email}</label>
                    <input
                      type="email"
                      required
                      className="form-input w-full bg-white/20 border border-white/30 rounded-lg px-4 py-3 text-white placeholder-white/70 focus:outline-none focus:border-white"
                  ...
                  <div>
                    <label className="block text-sm font-semibold mb-2">{t.cta.form.phone}</label>
                    <input
                      type="tel"
                      required
                      className="form-input w-full bg-white/20 border border-white/30 rounded-lg px-4 py-3 text-white placeholder-white/70 focus:outline-none focus:border-white"
                  ...
                  <div>
                    <label className="block text-sm font-semibold mb-2">{t.cta.form.track}</label>
                ...
                <div>
                  <label className="block text-sm font-semibold mb-2">{t.cta.form.message}</label>
                  <textarea
                    rows="4"
                    className="form-input w-full bg-white/20 border border-white/30 rounded-lg px-4 py-3 text-white placeholder-white/70 focus:outline-none focus:border-white"
