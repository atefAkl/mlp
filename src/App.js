...
const App = () => {
  ...
  {
    quote: "البيئة المحاكاة أعطتني الخبرة العملية التي تفتقدها الجامعات. بنيت معرض أعمال حقيقي.",
    name: "فاطمة علي",
    position: "Frontend Developer",
    company: "شركة ناشئة",
  },
  {
    quote: "تعلمت كيفية العمل ضمن فرق Agile وGit Workflow احترافي. هذا كان المفتاح لوظيفتي الحالية.",
    name: "محمد خالد",
    position: "Backend Developer",
    company: "شركة استشارية",
  },
  {
    quote: "أجمل ما في موثق هو الـ Code Review؛ تعلمت كتابة كود نظيف وقابل للصيانة.",
    name: "سارة حسن",
    position: "Mobile Developer",
    company: "Solutions Hub",
  },
  {
    quote: "انتقلت من مرحلة التخبط في التعلم إلى مرحلة الاحتراف بفضل المسار الواضح والمهام المحددة.",
    name: "عمر يحيى",
    position: "UI/UX Designer",
    company: "Creative Agency",
  },
  {
    quote: "أدركت أخيراً معنى الـ Deadline وكيفية إدارة وقتي البرمجي بفعالية عالية.",
    name: "ليلى محمود",
    position: "Web Developer",
    company: "Digital Flow",
  },
  {
    quote: "التجربة فاقت توقعاتي، العمل على مشاريع حقيقية جعلني أستعد لسوق العمل في وقت قياسي.",
    name: "ياسين عبدالله",
  ...
  subtitle: "Experts from Mawthiq share their professional journeys",
  stories: [
    {
      quote: "Mawthiq helped me break the production fear barrier. Now, I work with confidence at a major tech company.",
      name: "Ahmed Mohammed",
      position: "Full Stack Developer",
      company: "Major Tech Company",
    },
    {
      quote: "The simulated environment provided the practical experience that universities lack. I built a real-world portfolio.",
      name: "Fatima Ali",
      position: "Frontend Developer",
      company: "Startup Co.",
    },
    {
      quote: "I learned how to work within Agile teams and professional Git Workflows. This was the key to my current job.",
      name: "Mohammed Khalid",
      position: "Backend Developer",
      company: "Consulting Firm",
    },
    {
      quote: "I moved from a stage of learning confusion to professionalism thanks to the clear path and defined tasks.",
      name: "Omar Yahya",
      position: "UI/UX Designer",
      company: "Creative Agency",
    },
    {
      quote: "The best part of Mawthiq is the Code Review; I learned how to write clean, maintainable code.",
      name: "Sara Hassan",
      position: "Mobile Developer",
      company: "Solutions Hub",
    },
    {
      quote: "Technical support and continuous code reviews enabled me to write Clean Code that any developer would be proud of.",
      name: "Saad Al-Fayez",
      position: "Frontend Developer",
      company: "Tech Solutions",
    },
    {
      quote: "I used to struggle with Deployment; at Mawthiq, I deployed my project myself and learned every single detail.",
      name: "Maryam Al-Otaibi",
      position: "Full Stack Developer",
      company: "Digital Systems",
    },
    {
      quote: "This experience isn't just a course; it's a real-world bootcamp that puts you on the right track for career success.",
      name: "Majed Sulaiman",
  ...
  return (
    ...
    <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
                  ...
                  <div className="tech-item-card group">
                    <div className="tech-geometric-box">
                      <div className="tech-box-face main-face">
                        <img src={tech.image} alt={tech.name} className="tech-icon-svg" />
                      </div>
      ...
      <section id="journey" className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        ...
        <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white" data-aos="fade-up">
          {t.success.title}
        </h2>
        <p className="text-lg text-white/70" data-aos="fade-up" data-aos-delay="100">
          {t.success.subtitle}
        </p>
        </div>
    ...
    />
      ...
      <section id="partners" className="py-24 px-4 bg-white border-y border-slate-100">
        <div className="max-w-7xl mx-auto">
