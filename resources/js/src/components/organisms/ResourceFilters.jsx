        ...
        <div className="bg-white p-3 rounded-xl shadow-sm border border-slate-200 flex flex-col md:flex-row items-center justify-between gap-3">
            ...
            <div className="flex flex-wrap items-center gap-2 w-full md:w-auto">
                <div className="relative flex-1 md:w-64 min-w-[150px]">
                    <span
                        className={`absolute inset-y-0 flex items-center text-slate-400 ${isRTL ? "right-3" : "left-3"}`}
                    >
                ...
                <Button
                    variant="secondary"
                    icon={faFilter}
                    className="text-[10px] font-bold py-1.5 px-3 uppercase tracking-wider"
                >
                    {t("auto.filters")}
                </Button>
            </div>
            ...
            {onSelectAll && (
                <div className="flex items-center gap-1 bg-slate-50 p-1 rounded-lg border border-slate-200 w-full md:w-auto justify-center md:justify-start">
                    ...
                    >
                        <FontAwesomeIcon
                            icon={faSync}
                            className="text-amber-500 text-[8px]"
                        />
                    ...
                    <div className="relative">
                        ...
                        >
                            <option value="" disabled>
                                {isRTL ? "العمليات الجماعية" : "Bulk Actions"}
                            </option>
                        ...
                        <div
                            className={`pointer-events-none absolute inset-y-0 flex items-center px-2 text-slate-400 ${isRTL ? "left-1" : "right-1"}`}
                        >
                            <FontAwesomeIcon
                                icon={faChevronDown}
                                className="text-[8px]"
