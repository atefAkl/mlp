...
import { ChevronRight, Rocket, Star, Users, Terminal, Target, CheckCircle2 } from "lucide-react";
import { trackEvent } from "../utils/analytics";

const HERO_GRADIENTS = {
    "from-deep-blue to-emerald":
...
const HeroSection = ({
    ...
    const activeGradient =
        HERO_GRADIENTS[t.hero.carousel[currentSlide]?.bg] ||
        "linear-gradient(135deg, #1e3a8a 0%, #10b981 100%)";
    ...
    return (
        <section
            role="main"
            aria-label="hero"
            className="min-h-[500px] h-[67vh] w-full overflow-hidden relative"
        >
            <div
                className="min-h-[500px] h-[67vh] w-full flex items-center text-white relative overflow-hidden"
