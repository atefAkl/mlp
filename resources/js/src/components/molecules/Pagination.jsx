        ...
        >
            <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest">
                {isRTL ? (
                    <>
                        عرض{" "}
                        <span className="text-slate-800">{showingItems}</span>{" "}
                        من <span className="text-slate-800">{totalItems}</span>{" "}
                        عنصر
                    </>
                ) : (
                    <>
                        Showing{" "}
                        <span className="text-slate-800">{showingItems}</span>{" "}
                        of <span className="text-slate-800">{totalItems}</span>{" "}
                        items
                    </>
                )}
            </div>
            ...
            <div className="flex items-center gap-1">
                ...
                >
                    <FontAwesomeIcon
                        icon={isRTL ? faAnglesRight : faAnglesLeft}
                        className="text-[10px]"
                    />
                </button>
                ...
                >
                    <FontAwesomeIcon
                        icon={isRTL ? faAnglesLeft : faAnglesRight}
                        className="text-[10px]"
                    />
                </button>
            </div>
