...
const CourseDetails = ({ t, lang, onBack, onEnroll }) => {
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid lg:grid-cols-12 gap-12 items-start">
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                {cd.curriculum.map((module, idx) => (
                                    <div
                                        key={idx}
                                        className="relative pl-8 rtl:pl-0 rtl:pr-8 pb-8 last:pb-0 group"
                                    >
                                        {/* Vertical Line */}
                                        ...
                                        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm transition-all group-hover:border-emerald-200 group-hover:shadow-md">
                                            <span className="text-xs font-bold text-emerald-600 mb-1 block uppercase">
                                                {module.week}
                                            </span>
                            ...
                            <div className="grid sm:grid-cols-3 gap-8 relative z-10">
                                <div>
                                    <h4 className="text-xs font-black text-emerald-400 uppercase tracking-widest mb-4">
                                        {isRtl ? "الواجهات" : "Frontend"}
                                    </h4>
                                    <div className="flex flex-wrap gap-2">
                                        {cd.techStack.frontend.map((t) => (
                                            <span
                                                key={t}
                                                className="px-3 py-1 bg-white/10 rounded-full text-xs border border-white/5"
                                            >
                                                {t}
                                            </span>
                                        ))}
                                ...
                                <div>
                                    <h4 className="text-xs font-black text-emerald-400 uppercase tracking-widest mb-4">
                                        {isRtl ? "الخوادم" : "Backend"}
                                    </h4>
                                    <div className="flex flex-wrap gap-2">
                                        {cd.techStack.backend.map((t) => (
                                            <span
                                                key={t}
                                                className="px-3 py-1 bg-white/10 rounded-full text-xs border border-white/5"
                                            >
                    ...
                    <div className="lg:col-span-4 sticky top-24 space-y-6">
                        ...
                        <motion.div
                            variants={itemVariants}
                            className="bg-white rounded-3xl border border-slate-200 shadow-xl p-6 md:p-8"
                        >
                            <div className="flex justify-between items-center mb-6">
                                <span className="text-slate-500 text-sm font-medium">
                                    {isRtl ? "مدة الدورة" : "Duration"}
                                </span>
                            ...
                            <div className="mt-8 pt-8 border-t border-slate-100">
                                <h5 className="text-sm font-bold text-slate-900 mb-4">
                                    {isRtl ? "بماذا تخرج؟" : "What's Included?"}
                                </h5>
                                <ul className="space-y-3">
                                    {[
                                        isRtl
                                            ? "مشاريع بنظام Sprints"
                        ...
                        >
                            <h4 className="font-bold text-emerald-900 mb-2">
                                {isRtl ? "هل لديك تساؤلات؟" : "Any questions?"}
                            </h4>
                            <p className="text-sm text-emerald-800/70 mb-4">
                                {isRtl
                                    ? "راجع الأسئلة الشائعة أو تواصل مع فريقنا."
                                    : "Check our FAQ or talk to our team."}
                            </p>
