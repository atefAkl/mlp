...
const LoginPage = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      toast.success(t('auto.logged_in_successfully'));
      navigate('/dashboard');
    } catch (err) {
      console.error('Failed to login:', err);
      const errorMessage = err.data?.message || (t('auto.invalid_credentials'));
      toast.error(errorMessage);
    }
  };

  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4" dir={t('auto.ltr')}>
        ...
        <div className="p-8">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <Button
              ...
              disabled={isLoading}
            >
              {isLoading ? (t('auto.loading')) : t('common.login')}
            </Button>
          </form>
        </div>
